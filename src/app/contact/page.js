                ...
                <div className="p-6 bg-white rounded-2xl shadow">
                  ...
                  <ul className="mt-4 space-y-3 text-sm text-gray-700">
                    <li className="flex items-start gap-3">
                      <div className="w-10 h-10 bg-red-600 text-white flex items-center justify-center rounded-lg flex-shrink-0">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <a 
                          href="mailto:info@caminoconcepts.com" 
                          className="text-red-600 hover:text-red-700 font-medium transition-colors duration-200 hover:underline break-all"
                        >
                          info@caminoconcepts.com
                        </a>
                      </div>
                    </li>
