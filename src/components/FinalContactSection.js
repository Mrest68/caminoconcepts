              ...
              <div className="text-center">
                ...
                <div className="space-y-4 mb-8">
                  ...
                  <div className="flex items-center justify-center">
                    ...
                    <span className="text-gray-700 font-medium">info@caminoconcepts.com</span>
                  </div>
                  <div className="flex items-center justify-center">
                    <svg className="w-5 h-5 text-red-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a 
                  ...
                  className="block w-full bg-gray-800 text-white font-bold py-4 px-8 rounded-xl hover:bg-gray-900 transition-all duration-300 transform hover:scale-105 text-lg text-center"
                >
                  CONTACT US NOW
                </a>
              </div>
