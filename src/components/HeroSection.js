...
export default function HeroSection() {
  ...
  return (
    <section className="min-h-screen relative flex overflow-hidden bg-white">
      {/* Left Half - Logo and Contact with Image Carousel */}
      <div className={`w-1/2 relative flex flex-col justify-center items-center p-8 md:p-16 transition-all duration-1000 overflow-hidden ${
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-8 left-1/2 transform -translate-x-1/2 z-20 pointer-events-none">
            <img 
              ...
              className="w-80 h-32 md:w-96 md:h-40 object-contain opacity-60"
            />
          </div>
        </div>
        ...
        <div className="text-center relative z-20">
          ...
          <button className="bg-white text-red-500 font-semibold py-3 px-8 rounded-full hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 mb-8">
            Contact Us Now
          </button>
          ...
          <div className="flex justify-center space-x-4">
            ...
            <Link 
              ...
              className="group flex items-center justify-center w-12 h-12 bg-white/20 backdrop-blur-sm border border-white/30 rounded-full hover:bg-white/30 transition-all duration-300 hover:scale-110"
      ...
      <div className={`w-1/2 flex flex-col justify-center items-start p-8 md:p-16 bg-gradient-to-br from-gray-50 to-white relative transition-all duration-1000 ${
        isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'
      }`}>
        ...
        <div className="max-w-lg relative z-10">
          {/* Award Badge */}
          <div className="inline-flex items-center bg-red-50 text-red-600 px-4 py-2 rounded-full text-sm font-semibold mb-6 border border-red-100">
          ...
          <div className="flex items-center gap-6 mb-6">
            ...
            <div className="flex-shrink-0 hidden lg:block">
              <img
                src="/handyman.png"
                alt="Handyman"
                className="w-64 h-64 xl:w-80 xl:h-80 2xl:w-96 2xl:h-96 object-contain drop-shadow-2xl"
              />
            </div>
          </div>
          ...
          <div className="space-y-4">
            <button
              ...
              className="group w-full bg-gradient-to-r from-red-500 to-red-600 text-white font-semibold py-5 px-8 rounded-2xl hover:from-red-600 hover:to-red-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl relative overflow-hidden"
            >
            ...
            <button
              ...
              className="group w-full bg-gradient-to-r from-gray-800 to-gray-900 text-white font-semibold py-5 px-8 rounded-2xl hover:from-gray-900 hover:to-black transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl relative overflow-hidden"
            >
              <span className="relative z-10 flex items-center justify-center">
                <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
